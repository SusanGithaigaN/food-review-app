...
// update some fields of the document @click
async function updateCafe() {
  const updatedCafeDoc = await updateDoc(docRef, {
    //   update it with whatever's inside editCafe()
    ...editCafe.value
  });
}
</script>
    ...
    <template v-slot:content>
      <BaseCard>
        ...
        <template v-slot:actions>
          <BaseButton @click="updateCafe" variant="tonal" color="success"> Save Changes </BaseButton>
